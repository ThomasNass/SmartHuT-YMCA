...
})({"1EEwH":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "1dbf7e3ca28c48d1";
...
},{}],"kT3Uc":[function(require,module,exports) {
...
(function webpackUniversalModuleDefinition(root, factory) {
     ...
     */ constructor(message){
        ...
        /** Error thrown when multiple errors have occured. */ /** @private */ class AggregateErrors extends Error {
 ...
 */ var LogLevel;
        ...
        /** The version of the SignalR client. */ const VERSION = "6.0.9";
        /** @private */ class Arg {
        ...
        /** @private */ async function sendMessage(logger, transportName, httpClient, url, accessTokenFactory, content, options) {
            let headers = {};
        ...
        /** @private */ function createLogger(logger) {
            if (logger === undefined) return new ConsoleLogger(LogLevel.Information);
        ...
        class FetchHttpClient extends HttpClient {
            ...
            getCookieString(url) {
                let cookies = "";
                if (Platform.isNode && this._jar) // @ts-ignore: unused variable
        ...
        // Licensed to the .NET Foundation under one or more agreements.
        // The .NET Foundation licenses this file to you under the MIT license.
        /** Default implementation of {@link @microsoft/signalr.HttpClient}. */ class DefaultHttpClient extends HttpClient {
        ...
        /** @private */ class HandshakeProtocol {
            ...
            parseHandshakeResponse(data) {
                ...
                if (isArrayBuffer(data)) {
                    ...
                    const textData = data;
                    const separatorIndex1 = textData.indexOf(TextMessageFormat.RecordSeparator);
     ...
     */ start() {
            ...
            async _startWithStateTransitions() {
                ...
                try {
                    ...
                    if (Platform.isBrowser) // Log when the browser freezes the tab so users know why their connection unexpectedly stopped working
     ...
     */ onreconnected(callback) {
            ...
            _processHandshakeResponse(data) {
                ...
                if (responseMessage.error) {
                    ...
                    this._logger.log(LogLevel.Error, message1);
            ...
            _invokeClientMethod(invocationMessage) {
                ...
                } else this._logger.log(LogLevel.Warning, `No client method with the name '${invocationMessage.target}' found.`);
            }
                ...
                while(nextRetryDelay !== null){
                    ...
                    try {
                        ...
                        if (this._reconnectedCallbacks.length !== 0) try {
                            ...
                            this._logger.log(LogLevel.Error, `An onreconnected callback called with connectionId '${this.connection.connectionId}; threw error '${e1}'.`);
                        }
                        return;
                    } catch (e2) {
        ...
        // Not exported from index.
        /** @private */ class AbortController_AbortController {
            constructor(){
                ...
                try {
                    while(this._running){
                        ...
                        try {
                            ...
                            else if (e instanceof TimeoutError) // Ignore timeouts and reissue the poll.
                            this._logger.log(LogLevel.Trace, "(LongPolling transport) Poll timed out, reissuing.");
                            else {
        ...
        /** @private */ class ServerSentEventsTransport {
            ...
            async connect(url, transferFormat) {
                ...
                return new Promise((resolve, reject)=>{
                    ...
                    let eventSource;
                    if (Platform.isBrowser || Platform.isWebWorker) eventSource = new this._options.EventSource(url, {
                        withCredentials: this._options.withCredentials
                    });
                    else {
            ...
            async _stopInternal(error) {
                ...
                if (this.transport) {
                    try {
                        ...
                        this._logger.log(LogLevel.Error, `HttpConnection.transport.stop() threw error '${e1}'.`);
                ...
                for (const endpoint of transports){
                    ...
                    if (transportOrError instanceof Error) {
                        ...
                        try {
                            ...
                            this._logger.log(LogLevel.Error, `Failed to start the transport '${endpoint.transport}': ${ex1}`);
                            negotiate = undefined;
                            transportExceptions.push(new FailedToStartTransportError(`${endpoint.transport} failed: ${ex1}`, HttpTransportType[endpoint.transport]));
                            if (this._connectionState !== "Connecting" /* Connecting */ ) {
        ...
        /** Implements the JSON Hub Protocol. */ class JsonHubProtocol {
            constructor(){
                ...
                /** @inheritDoc */ this.transferFormat = TransferFormat.Text;
            }
     ...
     */ build() {
        ...
        if (!Uint8Array.prototype.indexOf) Object.defineProperty(Uint8Array.prototype, "indexOf", {
            value: Array.prototype.indexOf,
            writable: true
        });
        if (!Uint8Array.prototype.slice) Object.defineProperty(Uint8Array.prototype, "slice", {
        ...
        if (!Uint8Array.prototype.forEach) Object.defineProperty(Uint8Array.prototype, "forEach", {
...
},{"process":"d5jf4"}]},["1EEwH","kT3Uc"], "kT3Uc", "parcelRequire2aa7")

//# sourceMappingURL=index.a28c48d1.js.map
